...
public class DmDocumentTypeModel {
    @Id
    ...
    public DmDocumentTypeModel(){}

    public DmDocumentTypeModel(String code, String name, String description, String created_by, Timestamp created_at, String updated_by, Timestamp updated_at) {
        this.code = code;
        this.name = name;
