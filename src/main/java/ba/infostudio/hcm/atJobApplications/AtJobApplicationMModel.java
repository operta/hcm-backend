...
import ba.infostudio.hcm.atVacancies.AtVacancyMModel;
...
public class AtJobApplicationMModel implements Serializable {
    @Id
    ...
    private AtVacancyMModel vacancyid;
    @ManyToOne
    ...
    public AtJobApplicationMModel() {
    }

    public AtJobApplicationMModel(AtApplicantModel applicantid, AtVacancyMModel vacancyid, AtJobApplicationStatusModel id_status, Long grade, String review, Date date_applied, String created_by, Timestamp created_at, String updated_by, Timestamp updated_at, Long interview_grade, Long test_grade, Collection<AtJobApplicationTestModel> test, Collection<AtJobApplicationInterviewModel> interview) {
    ...
    public AtVacancyMModel getVacancyid() {
        return vacancyid;
    }

    public void setVacancyid(AtVacancyMModel vacancyid) {
        this.vacancyid = vacancyid;
    }
