...
public class AtApplicantContactModel {
    @Id
    ...
    public AtApplicantContactModel(){}
    ...
    public AtApplicantContactModel(AtApplicantModel idApplicant, RgContactTypeModel id_contact_type, String contact, String description, String created_by, Timestamp created_at, String updated_by, Timestamp updated_at) {
        this.idApplicant = idApplicant;
        this.id_contact_type = id_contact_type;
        this.contact = contact;
        this.description = description;
