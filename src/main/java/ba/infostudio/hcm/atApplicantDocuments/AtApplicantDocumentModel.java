...
public class AtApplicantDocumentModel {
    @Id
    ...
    public AtApplicantDocumentModel(){}
    ...
    public AtApplicantDocumentModel(DmDocumentLinkModel id_document_link, AtApplicantModel idApplicant, DmDocumentTypeModel id_document_type, String name, String description, Date valid_from, Date valid_to, String created_by, Timestamp created_at, String updated_by, Timestamp updated_at) {
        this.id_document_link = id_document_link;
        this.idApplicant = idApplicant;
        this.id_document_type = id_document_type;
        this.name = name;
