...
public class AtApplicantAccomplishmentModel {
    @Id
    ...
    public AtApplicantAccomplishmentModel(){}

    public AtApplicantAccomplishmentModel(AtApplicantModel idApplicant, AtAccomplishmentTypesModel id_accomplishment_type, String title, String description, String location, String association, String ongoing, String link, Date date_from, Date date_to, String proficiency, String occupation, String licence_number, String created_by, Timestamp created_at, String updated_by, Timestamp updated_at) {
